#!/bin/sh
rm obj/* -f
g++ pdcserver.cpp backend_ceph.cpp pipe.cpp type.cc pdc_lock.cpp -g -std=c++11 -o obj/server -lpthread -Wl,-rpath=/lib64/pdc/ -lrbd -lrados  2>obj/server.log

#g++ libpdc.cpp pdcclient.cpp backend_ceph.cpp pipe.cpp type.cc pdc_lock.cpp -g -o obj/client -lpthread  2>obj/client.log
g++ -shared -fPIC libpdc.cc pdcclient.cpp backend_client.cpp pipe.cpp type.cc pdc_lock.cpp -g -std=c++11 -o obj/libpdc.so.1.0.0 -lpthread
